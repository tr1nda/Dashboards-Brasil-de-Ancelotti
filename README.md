...
Este projeto é um dashboard interativo desenvolvido para analisar estatísticas de desempenho dos jogadores da Seleção Brasileira durante os jogos do ciclo (simulado) sob o comando de Carlo Ancelotti. 
...
* **Matriz de Correlação e Eficiência:** Gráficos de dispersão (Scatter Plots) para avaliar a taxa de conversão dos atletas (ex: *Passes vs Passes Certos*, *Duelos vs Duelos Ganhos*), incluindo uma linha de tendência ideal para facilitar a visualização de quem tem 100% de aproveitamento.
